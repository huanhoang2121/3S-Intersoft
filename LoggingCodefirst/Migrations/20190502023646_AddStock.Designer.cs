...
namespace LoggingCodefirst.Migrations
{
    ...
    [Migration("20190502023646_AddStock")]
            ...
            modelBuilder.Entity("LoggingCodefirst.Models.Sales.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            Password = "10000:6QXrmFjbijleotVdaPZ/dzDasOE7FTokoarPXoy8jSD4LSqo",
                            Phone = "0131651234",
                            StoreId = 1
                        });
                });
            ...
            modelBuilder.Entity("LoggingCodefirst.Models.Production.Stock", b =>
                {
                    b.HasOne("LoggingCodefirst.Models.Production.Product", "Product")
                        .WithOne("Stock")
                        .HasForeignKey("LoggingCodefirst.Models.Production.Stock", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("LoggingCodefirst.Models.Sales.Store", "Store")
                        .WithOne("Stock")
                        .HasForeignKey("LoggingCodefirst.Models.Production.Stock", "StoreId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
