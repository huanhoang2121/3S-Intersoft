...
{
    public class BrandCreateValidator: AbstractValidator<BrandCreateViewModel>
    {
        public BrandCreateValidator(IStringLocalizer<BrandCreateValidator> localizer, IBrandService brandService)
        {
