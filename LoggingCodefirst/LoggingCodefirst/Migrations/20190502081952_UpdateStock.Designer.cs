...
namespace LoggingCodefirst.Migrations
{
    ...
    [Migration("20190502081952_UpdateStock")]
            ...
            modelBuilder.Entity("LoggingCodefirst.Models.Sales.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            Password = "10000:8hFR2+G3LNBPdHeacN1Y1NPUIKz1SNZMc4LoNxW/q9xNaUkq",
                            Phone = "0131651234",
                            StoreId = 1
                        });
                });
            ...
            modelBuilder.Entity("LoggingCodefirst.Models.Production.Product", b =>
                {
                    ...
                    b.HasOne("LoggingCodefirst.Models.Production.Stock", "Stock")
                        .WithMany("Products")
